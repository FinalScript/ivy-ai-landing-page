...
const CalendarDemo: React.FC = () => {
  ...
  return (
    <div className="relative py-10 sm:py-12 lg:py-16 bg-gray-50 overflow-hidden" 
      style={{ 
        position: 'relative',
        isolation: 'isolate'
      }}
    >
      ...
      <div 
        ...
        style={{ 
          backgroundImage: 'url("/ivy_lecturehall.jpg")',
      ...
      <div 
        className="absolute inset-0 z-0" 
        style={{ 
          background: 'linear-gradient(to bottom, rgba(255, 255, 255, 1.0) 0%, rgba(255, 255, 255, 0.95) 30%, rgba(255, 255, 255, 0.6) 35%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.1) 100%)'
        }}
      ></div>
    
      <motion.div
        className="max-w-5xl mx-auto px-3 sm:px-4 relative z-10"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <motion.h2
          ...
          className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-2 sm:mb-4"
        >
        ...
        <motion.p 
          variants={itemVariants}
          className="text-center text-sm sm:text-base lg:text-lg text-gray-700 max-w-xl sm:max-w-2xl mx-auto mb-6 sm:mb-8 lg:mb-12"
        >
        ...
        {/* Container */}
        <div className="max-w-6xl mx-auto mt-4 sm:mt-8 md:mt-10 relative z-10">
