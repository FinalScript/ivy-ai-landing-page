...
import { Rive, Layout as RiveLayout, Fit, Alignment } from "@rive-app/webgl2";
...
// RiveAnimation props interface
interface RiveAnimationProps {
  maxWidth?: string;
  aspectRatio?: string;
}

// Create a custom Rive animation component using the WebGL2 renderer directly
const RiveAnimation = ({
  maxWidth = "500px",
  aspectRatio = "5/3",
}: RiveAnimationProps) => {
  ...
  useEffect(() => {
    // Helper to update canvas size based on container
    const updateCanvasSize = () => {
      if (canvasRef.current && containerRef.current) {
        ...
        if (riveInstanceRef.current) {
          riveInstanceRef.current.resizeToCanvas();
        }
      }
    };
    ...
    const loadRiveAnimation = async () => {
      if (canvasRef.current && !riveInstanceRef.current) {
        try {
          console.log("Creating Rive instance...");

          // Create the Rive instance with responsive settings
          const r = new Rive({
            canvas: canvasRef.current,
            src: "/ivy_ai.riv",
            artboard: "landingpage_main",
            autoplay: true,
            ...
            onLoad: () => {
              ...
              } else if (r.animationNames && r.animationNames.length > 0) {
          ...
          console.error("Error initializing Rive animation:", err);
        }
      }
    };
  ...
  return (
    <div
      ...
      style={{
        width: "100%",
        maxWidth: maxWidth,
        aspectRatio: aspectRatio, // Set aspect ratio to maintain proportions
        margin: "0 auto",
        position: "relative",
      }}
    >
...
function Index() {
  ...
  const renderEventContent = (eventInfo: EventContentArg) => {
    ...
    return (
      <div
        className={twMerge(
          "p-1.5 flex flex-col h-full relative",
  ...
  return (
    <div className="min-h-screen bg-white text-[#171919] font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="#features"
                className="text-[15px] text-gray-600 hover:text-[#11ba82] transition-colors font-semibold"
              >
                Features
              </a>
              <a
      ...
      <div className="flex flex-col">
        {/* Rive Animation - with larger size */}
        <div className="w-full py-8 md:py-12">
          <RiveAnimation maxWidth="700px" aspectRatio="5/3" />
        </div>

        {/* Text Content Below Animation */}
        <div className="bg-white py-8 md:py-16">
          <div className="max-w-4xl mx-auto text-center px-4">
            <h1 className="text-4xl md:text-7xl leading-[1.1] font-extrabold mb-6 transition-all duration-300 ease-in-out">
            ...
            <button
              className="bg-[#11ba82] text-[#fffffa] px-8 py-3 rounded-3xl text-[16px] font-semibold hover:bg-[#0ea371] transition-colors"
        ...
        <div className="bg-white rounded-[12px] shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08),0_8px_32px_-2px_rgba(0,0,0,0.12),0_0_48px_0_rgba(0,0,0,0.06)] overflow-hidden border border-gray-100/50 backdrop-blur-xl relative ring-1 ring-black/5">
          ...
          <div className="border-b border-gray-100">
            ...
            <div className="px-6 py-3 flex items-center justify-between border-t border-b border-gray-200/80 bg-white/95 backdrop-blur-xl relative z-10">
              ...
              <div className="flex items-center gap-2">
                <div className="text-sm text-gray-700 px-3 py-1.5 rounded-md hover:bg-gray-100 cursor-pointer">
                  Today
                </div>
                <div className="h-4 w-[1px] bg-gray-300"></div>
                <div className="text-sm text-gray-700 px-3 py-1.5 rounded-md bg-gray-100">
                  Week
                </div>
                <div className="text-sm text-gray-700 px-3 py-1.5 rounded-md hover:bg-gray-100 cursor-pointer">
                  Month
          ...
          <div className="flex">
            ...
            <div className="w-64 shrink-0 py-6 px-4 space-y-6 bg-gray-50/90 backdrop-blur-xl border-r border-gray-200/80 relative z-10">
              <div className="space-y-3">
                <h4 className="text-[13px] font-semibold text-gray-900 uppercase tracking-wide px-2">
                  Quick Access
                </h4>
      ...
      <div id="features" className="py-24 bg-white scroll-mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="text-[#11ba82] font-semibold text-sm tracking-wider uppercase mb-3 block">
              Features
            </span>
            <h2 className="text-4xl font-bold text-[#171919] mb-4">
              Your Academic Life, Intelligently Organized
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-[#171919] mb-3">
                AI-Powered Syllabus Analysis
              </h3>
              <p className="text-[#171919]/70 leading-relaxed">
                Our advanced AI reads and understands your course outlines like
                a human would, automatically extracting key dates and
                requirements.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-[#171919]/70 leading-relaxed">
                Get intelligent notifications that adapt to your study patterns
                and help you stay ahead of deadlines.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mb-6">
              ...
              <p className="text-[#171919]/70 leading-relaxed">
                Seamlessly integrates with Google Calendar, Apple Calendar, and
                other popular platforms to keep you in sync everywhere.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <span className="bg-[#ba1511]/10 text-[#ba1511] text-sm font-semibold px-3 py-1 rounded-full inline-block mb-4">
                Step 1
              </span>
              <h3 className="text-xl font-semibold text-[#171919] mb-3">
                Upload Your Syllabi
              ...
              <p className="text-[#171919]/70 leading-relaxed">
                Simply upload your course syllabi and materials. Our AI will
                automatically process and analyze them.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="w-16 h-16 bg-[#ba1511]/10 rounded-xl flex items-center justify-center mb-6">
              ...
              <p className="text-[#171919]/70 leading-relaxed">
                Check the automatically generated schedule and customize it to
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-[#171919]/70 leading-relaxed">
                Access your schedule anywhere and receive smart notifications
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/"
                    className="text-gray-600 hover:text-[#11ba82] transition-colors"
                  >
                    Features
                  </Link>
                </li>
